...
export const getAllBlogs = createAsyncThunk("blogs/getAll", async (page, {rejectWithValue}) => {
  try {
    const { data } = await axios.get(`https://blog-api1-z30x.onrender.com/api/blogs?page=${page}`);
    return data;
  } catch (err) {
...
export const SearchBlog = createAsyncThunk("/blog/search", async (searchQuery,{rejectWithValue}) => {
  try {
    const { data } = await axios.get(`https://blog-api1-z30x.onrender.com/api/blogs/search?searchQuery=${searchQuery}`);
    return data;
  } catch (err) {
    return rejectWithValue(err.response.data);
  }
...
export const getBlog = createAsyncThunk("blog/getblog", async (id) => {
  try {
    const { data } = await axios.get(`https://blog-api1-z30x.onrender.com/api/blogs/${id}`);
    return data;
  } catch (error) {
    console.log(error);
  }
  ...
  async (
    ...
    try {
      const { data } = await axios.post(
        "https://blog-api1-z30x.onrender.com/api/blogs",
        blogData,
        config
      );
  ...
  async (
    ...
    try {
      const { data } = await axios.put(
        `https://blog-api1-z30x.onrender.com/api/blogs/${id}`,
        updatedBlog,
        config
      );
  ...
  async (
    ...
    try {
      const { data } = await axios.patch(
         `https://blog-api1-z30x.onrender.com/api/blogs/like/${id}`,{id},
        config
      );
      return data;
    } catch (err) {
